...
android {
    namespace = "org.example.consumer.test"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "org.example.consumer.test"
...
compose.desktop {
    application {
        mainClass = "org.example.consumer.test.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "org.example.consumer.test"
